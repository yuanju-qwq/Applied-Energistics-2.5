 ...
 */
public class ItemSpecialEncodedPatternBakedModel implements IBakedModel {
    ...
    public static final IItemColor PATTERN_ITEM_COLOR_HANDLER = (stack, tintIndex) -> {
        ItemSpecialEncodedPattern iep = (ItemSpecialEncodedPattern) stack.getItem();
    ...
    private class CustomOverrideList extends ItemOverrideList {
        ...
        CustomOverrideList() {
            super(ItemSpecialEncodedPatternBakedModel.this.baseModel.getOverrides().getOverrides());
        }
