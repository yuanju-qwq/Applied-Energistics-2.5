...
public final class ApiParts implements IParts {
    ...
    private final IItemDefinition patternProvider;
    ...
    public ApiParts(FeatureFactory registry, PartModels partModels) {
        ...
        this.patternProvider = new DamagedItemDefinition("part.pattern_provider",
                itemPart.createPart(PartType.PATTERN_PROVIDER));
    ...
    @Override
    public IItemDefinition patternProvider() {
